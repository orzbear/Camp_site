...
public interface CampsiteRepository
        extends JpaRepository<Campsite, Long>, JpaSpecificationExecutor<Campsite> {

    /** Find campsites by park */
    List<Campsite> findByParkId(Long parkId);

    /**
     * Search campsites with basic filters (simplified query to avoid complex joins)
     */
    @Query("""
